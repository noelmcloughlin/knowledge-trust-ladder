...
Same rules as ktl-curator's `references/trust-fields.md`; restated here so this skill stands alone:
...
once that ktl-sidecar can create a bundle so the next reader doesn't repeat the search. Don't create `.lokf/feedback.md` in that case - there is
